...
export namespace TokenUtils {
  export interface TokenUtilsInterface {
    setSelected: (
  ...
  export class TokenUtilsImplementation implements TokenUtilsInterface {
    constructor() {}
        ...
        Object.entries(values).forEach(([property, val]) => {
          if (!!val.attribute_name) {
            ...
            token.set(
              ...
              NibroCore.NibroCore.getAttributeId(character_id, val.link),
            );
          }
        });
      });
  ...
  export let TokenUtils: TokenUtilsInterface = new TokenUtilsImplementation();
}
